        ...
        if response.status_code == 200:
            ...
            for job_element in job_elements:
                try:
                    ...
                    opening_date_element = job_element.select_one("td:nth-of-type(3)")
                    closing_date_element = job_element.select_one("td:nth-of-type(5)")
                    ...
                    if position_element and employer_element and opening_date_element and closing_date_element:
                        ...
                        opening_date = opening_date_element.find_next_sibling().get_text(strip=True)  # Adjusted this line to correctly extract opening date
