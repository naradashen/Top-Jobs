    ...
    try:
        ...
        if response.status_code == 200:
            ...
            for job_element in job_elements:
                try:
                    position_element = job_element.select_one("td[width='28%']")
                    employer_element = job_element.select_one("h1")
                    opening_date_element = job_element.select_one("td[nowrap='true']:nth-of-type(2)")
                    closing_date_element = job_element.select_one("td[nowrap='true']:nth-of-type(3)")
                    ...
                    if position_element and employer_element and opening_date_element and closing_date_element:
                        ...
                        print("|".join([position, employer, "N/A", opening_date, closing_date]))
                        total_jobs.append({
                            "Position": position,
                            "Employer": employer,
